...
extern __gshared Object* gCutsceneFocus;
extern __gshared Object* gSecondCameraFocus;
...
void object_pos_to_vec3f (Vec3f dst, Object* o);
void vec3f_to_object_pos (Object* o, Vec3f src);
int move_point_along_spline (Vec3f p, CutsceneSplinePoint* spline, short* splineSegment, f32* progress);
...
int collide_with_walls (Vec3f pos, f32 offsetY, f32 radius);
...
int clamp_positions_and_find_yaw (Vec3f pos, Vec3f origin, f32 xMax, f32 xMin, f32 zMax, f32 zMin);
int is_range_behind_surface (Vec3f from, Vec3f to, Surface* surf, short range, short surfType);
...
short next_lakitu_state (Vec3f newPos, Vec3f newFoc, Vec3f curPos, Vec3f curFoc, Vec3f oldPos, Vec3f oldFoc, short yaw);
...
int rotate_camera_around_walls (Camera* c, Vec3f cPos, short* avoidYaw, short yawRange);
void find_mario_floor_and_ceil (PlayerGeometry* pg);
ubyte start_object_cutscene_without_focus (ubyte cutscene);
short cutscene_object_with_dialog (ubyte cutscene, Object* o, short dialogID);
short cutscene_object_without_dialog (ubyte cutscene, Object* o);
short cutscene_object (ubyte cutscene, Object* o);
...
void obj_rotate_towards_point (Object* o, Vec3f point, short pitchOff, short yawOff, short pitchDiv, short yawDiv);

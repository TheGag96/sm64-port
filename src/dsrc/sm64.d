...
enum ACT_SPIN_POUND_LAND            = 0x00800237; // (0x037 | ACT_FLAG_STATIONARY | ACT_FLAG_ATTACKING)
...
enum ACT_ROLL                       = 0x0004045B; // (0x05B | ACT_FLAG_MOVING | ACT_FLAG_BUTT_OR_STOMACH_SLIDE)
...
enum ACT_GROUND_POUND_JUMP          = 0x01000884; // (0x084 | ACT_FLAG_AIR | ACT_FLAG_ALLOW_VERTICAL_WIND_ACTION)
...
enum ACT_SPIN_JUMP                  = 0x0100088B; // (0x08B | ACT_FLAG_AIR | ACT_FLAG_ALLOW_VERTICAL_WIND_ACTION)
...
enum ACT_SPIN_POUND                 = 0x0080088F; // (0x08F | ACT_FLAG_AIR | ACT_FLAG_ATTACKING)
...
enum ACT_LEDGE_PARKOUR              = 0x0000089D; // (0x09D | ACT_FLAG_AIR)
...
enum ACT_ROLL_AIR                   = 0x010008BA; // (0x0BA | ACT_FLAG_AIR | ACT_FLAG_ALLOW_VERTICAL_WIND_ACTION)
...
enum ACT_WALL_SLIDE                 = 0x01000CBF; // (0x0BF | ACT_FLAG_AIR | ACT_FLAG_MOVING | ACT_FLAG_ALLOW_VERTICAL_WIND_ACTION)
...
enum ACT_WATER_GROUND_POUND         = 0x308024C9; // (0x0C9 | ACT_FLAG_MOVING | ACT_FLAG_SWIMMING | ACT_FLAG_SWIMMING_OR_FLYING | ACT_FLAG_WATER_OR_TEXT | ACT_FLAG_ATTACKING)
enum ACT_WATER_GROUND_POUND_LAND    = 0x300024CA; // (0x0CA | ACT_FLAG_STATIONARY | ACT_FLAG_SWIMMING | ACT_FLAG_SWIMMING_OR_FLYING | ACT_FLAG_WATER_OR_TEXT)
enum ACT_WATER_GROUND_POUND_STROKE  = 0x300024CB; // (0x0CB | ACT_FLAG_MOVING | ACT_FLAG_SWIMMING | ACT_FLAG_SWIMMING_OR_FLYING | ACT_FLAG_WATER_OR_TEXT)
enum ACT_WATER_GROUND_POUND_JUMP    = 0x300024CC; // (0x0CC | ACT_FLAG_MOVING | ACT_FLAG_SWIMMING | ACT_FLAG_SWIMMING_OR_FLYING | ACT_FLAG_WATER_OR_TEXT)
